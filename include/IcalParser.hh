...
public:
        ...
        optional<Date> date();
        optional<TimeHour> time_hour();
        optional<TimeMinute> time_minute();
        optional<TimeSecond> time_second();
        ...
        optional<TzProp> tzprop();
        optional<FrmParam> frmparam();
        optional<ToParam> toparam();
        optional<UtcOffset> utc_offset();
        optional<TimeNumZone> time_numzone();
        optional<TzOffsetTo> tzoffsetto();
        optional<TzOffsetFrom> tzoffsetfrom();
        optional<TzNParam> tznparam();
        optional<TzName> tzname();
